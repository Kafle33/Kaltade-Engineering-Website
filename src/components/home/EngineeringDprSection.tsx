      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mb-16">
          <div className="lg:col-span-6 space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-navy-100 text-navy-900 text-xs font-bold uppercase tracking-wider">
              <Compass className="w-4 h-4 text-navy-800" />
        ...
        <div className="p-8 sm:p-12 rounded-3xl bg-navy-900 text-white border border-navy-800 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-8">
            ...
            <div>
              <div className="text-xs font-mono uppercase tracking-wider text-blue-300 mb-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3">
                {dprWorkflow.map((item) => (
                  <div
                    key={item.step}
                    className="p-3.5 rounded-xl bg-white/5 border border-white/10 flex flex-col justify-between hover:bg-white/10 transition-colors"
                  >
                    <div>
